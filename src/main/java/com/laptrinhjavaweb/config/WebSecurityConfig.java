...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    //Bean này được cung cấp cho AuthenticationManagerBuilder bên dưới
    @Bean
    ...
    protected void configure(HttpSecurity http) throws Exception {
                http.csrf().disable()
                .authorizeRequests()
                        .antMatchers("/admin/building").authenticated()//hasAnyRole("manager","staff")
                        .antMatchers("/admin/building-edit", "/admin/customer-edit").hasRole("manager")
                        .antMatchers("/admin/building-edit-**", "/admin/customer-edit-**").authenticated()
