...
//    List<UserEntity> findByBuildingAssignment_Building_Id(Long buildingId);

    List<UserEntity> findByBuildings(BuildingEntity buildingEntity);
    List<UserEntity> findByCustomers(CustomerEntity customerEntity);
