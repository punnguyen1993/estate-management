	...
	<div class="container text-center">
		...
		<div class="login-form">
			<div class="main-div">
				...
				<div>
					<img width="10%" src="${pageContext.request.contextPath}/img/building.png">
				</div>
				<div class="space-4"></div>
				<form action="j_spring_security_check" style="max-width: 350px; margin: 0 auto" id="formLogin" method="post">
